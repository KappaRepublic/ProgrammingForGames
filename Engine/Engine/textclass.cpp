						   ...
						   D3DXMATRIX baseViewMatrix)
{
	...
	result = UpdateSentence(m_sentence1, "Welcome to my", 100, 100, 1.0f, 1.0f, 1.0f, deviceContext);
	if(!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence2, "World", 100, 116, 1.0f, 1.0f, 0.0f, deviceContext);
	if(!result)
	{
		return false;
	}
